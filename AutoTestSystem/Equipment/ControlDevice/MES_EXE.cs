...
{
    class MES_EXE : ControlDeviceBase
    {
        ...
        public override bool Init(string strParamInfo)
        {
            if(p == null)
            {
                ...
                string exePath = Path.Combine(baseDirectory, "Utility\\MESEXE\\MES.exe");
        ...
        public override bool Clear()
        {
            try
            {
                ...
                //    p.Dispose();
                //}
                LogMessage("MES_EXE Clear Queue");
                return true;
            }
            catch (Exception ex)
            {
        ...
        public override bool SEND(string data)
        {
            try
            {
                ...
                p.StartInfo.Arguments = parts.Length == 2 ? parts[1] : "";
